      ...
      <div className={`middle ${s.middle}`} data-ent="up" data-ent-delay="240">
        <div className={s.final}>
          <div className={s.hero}>
            ...
            >
              <g className={s.spark} style={{ "--dx": "-52px", "--dy": "-46px" } as React.CSSProperties}>
                <circle cx="100" cy="20" r="9" fill="var(--gold)" stroke="var(--ink)" strokeWidth="3" />
              </g>
              <g className={s.spark} style={{ "--dx": "48px", "--dy": "-52px" } as React.CSSProperties}>
                <circle cx="100" cy="20" r="7" fill="var(--gold)" stroke="var(--ink)" strokeWidth="3" />
              </g>
              <g className={s.spark} style={{ "--dx": "-72px", "--dy": "-14px" } as React.CSSProperties}>
                <circle cx="100" cy="20" r="6" fill="var(--gold)" stroke="var(--ink)" strokeWidth="3" />
              </g>
              <g className={s.spark} style={{ "--dx": "70px", "--dy": "-8px" } as React.CSSProperties}>
                <circle cx="100" cy="20" r="8" fill="var(--gold)" stroke="var(--ink)" strokeWidth="3" />
              </g>
            </svg>
          ...
          <div className={s.links}>
            <a className={`${s.link} ${s.primary}`} href="#" onClick={handleLink}>
              <svg
